...
Error details: ${bugDetails}`;
    ...
    let url = `https://github.com/Kirkman/StarTrekTimelinesSpreadsheet/issues/new?labels=${encodeURIComponent(labels)}&title=${encodeURIComponent(title)}&body=${encodeURIComponent(body)}`;
